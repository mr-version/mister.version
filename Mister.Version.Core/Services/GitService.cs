...
namespace Mister.Version.Core.Services
{
    ...
    public class GitService : IGitService
    {
        ...
        public VersionTag GetProjectVersionTag(string projectName, BranchType branchType, string tagPrefix)
        {
            ...
            {
                $"{projectName.ToLowerInvariant()}-{tagPrefix}",  // Standard format: facefirst.core-v
                $"{projectName}-{tagPrefix}",                      // Original case: FaceFirst.Core-v
                $"{projectName}/{tagPrefix}",                      // Slash format: FaceFirst.Core/v
                $"{projectName.ToLowerInvariant()}/{tagPrefix}",  // Lowercase slash: facefirst.core/v
            };
